...
scaler = MinMaxScaler()
w = numpy.array(finance_features)
scaler.fit(w)

rw = scaler.transform([200000, 1000000])
...
kmodel = KMeans(n_clusters=2).fit(finance_features)

pred = kmodel.predict(finance_features)
